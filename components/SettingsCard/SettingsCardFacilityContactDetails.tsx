...
import { updateFacilityContactInfo } from '@/api/supabase/queries/facilities';
...
export default function SettingCardFacilityContactDetails({
  ...
  setFacilityContactInfo: React.Dispatch<React.SetStateAction<UserInfo>>;
  userId: string;
}) {
  ...
  const handleSave = async () => {
    await updateFacilityContactInfo(userId, userInfo, editInfo);
    setFacilityContactInfo(editInfo);
    setIsEditable(!isEditable);
  };
